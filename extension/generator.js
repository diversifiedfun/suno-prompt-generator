...
16. VOCAL DELIVERY MODES (whispered, belted, falsetto, rapped, breathy, soft/intimate): Suno ignores a mid-line parenthetical like "(whispered)" or "(belt)" and ignores a bare inline [Belt]. Control delivery TWO ways that must AGREE: (a) state the mode in the STYLE field (e.g. "intimate breathy verses, belted chorus payoff"), and (b) tag the SECTION with a SHORT bracket on its own header line — [Chorus] [Belting, Powerful], [Verse] [Soft, Intimate], [Bridge] [Whispered, Intimate] — then clean lyric lines beneath (never put lyric words inside brackets). Use the tested tag forms ([Belting] not [Belt], [Whispered] not [Whisper]); keep each tag 1–3 words (long descriptive brackets get ignored). Put contrast BETWEEN sections (whispered verse → belted chorus), never contradictory words in one tag. A true whisper also needs that section kept sparse — Suno won't whisper over a wall of sound.
